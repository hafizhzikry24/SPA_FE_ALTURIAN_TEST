<template>
  <div class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full flex items-center justify-center">
    <div class="w-full max-w-md bg-white rounded-lg shadow-md p-8">
      <h1 class="text-2xl font-semibold text-gray-900 mb-2">{{ isEditing ? 'Edit Post' : 'Create Post' }}</h1>
      <p class="text-gray-600 mb-6">{{ isEditing ? 'Update your blog post details' : 'Create a new blog post' }}</p>
