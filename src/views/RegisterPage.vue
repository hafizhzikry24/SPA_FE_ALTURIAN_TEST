<template>
    <div class="min-h-screen flex items-center justify-center bg-gray-50">
      <div class="w-full max-w-md bg-white rounded-lg shadow-md p-8">
        ...
        <p class="text-gray-600 mb-6">Create a new account to access the platform</p>
        ...
        <form @submit.prevent="handleSubmit">
          <div class="space-y-6">
            ...
            <div>
              ...
              />
              <p v-if="validationErrors.password" class="text-sm text-red-600">{{ validationErrors.password }}</p>
            </div>
            ...
            <div>
              ...
              />
              <p v-if="validationErrors.password_confirmation" class="text-sm text-red-600">{{ validationErrors.password_confirmation }}</p>
            </div>
